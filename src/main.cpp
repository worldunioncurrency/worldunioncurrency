...
#if defined(NDEBUG)
# error "WorldUnionCurrency cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x5fc81aacb5a1422ff3b3ef52417348dbff4e64d45eebd3bc0e8f24681e11947a");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // WorldUnionCurrency: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "WorldUnionCurrency Signed Message:\n";
...
{
    // WorldUnionCurrency: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // WorldUnionCurrency: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // WorldUnionCurrency: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1495050310, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "1494782397";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0459c30b49190cffc3dca8672050a90246af19b6abbc4789182a9b31dfb1595e627e37ec689ca18e15977398ddd092f319604dadc1ec4a295959db9e0c02431b23") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1495050310;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1543858;
        ...
        assert(block.hashMerkleRoot == uint256("0x0d62415bd2f97d7695be09153ba1dfc20299baccbd6ee898f7d47318c06e660d"));
...
unsigned char pchMessageStart[4] = { 0xd0, 0xb5, 0x46, 0x3f }; // WorldUnionCurrency: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    //// debug print
    printf("WorldUnionCurrencyMiner:\n");
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("WorldUnionCurrencyMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("WorldUnionCurrencyMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static WorldUnionCurrencyMiner(CWallet *pwallet)
{
    printf("WorldUnionCurrencyMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("worldunioncurrency-miner");
    ...
    try { loop {
        ...
        printf("Running WorldUnionCurrencyMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("WorldUnionCurrencyMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&WorldUnionCurrencyMiner, pwallet));
}
